<?php include "header.php"; ?>
		...
		<div class="row">
			...
			<div class="panel panel-default">
				<div class="panel-body">
				<h2 style="text-muted"><span class="glyphicon glyphicon-tasks"></span> foto owner</h2>
				<h4>Hijab Queen Zahra</h4>
				<img src="gambar/raudah.jpeg" class="img-thumbnail img-responsive">
				<p></p>
				</div>
      </div>
